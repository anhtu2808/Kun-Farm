...
namespace KunFarm.DAL.Migrations
{
    ...
    [Migration("20250702220612_AddPlayerToolbar")]
    partial class AddPlayerToolbar
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KunFarm.DAL.Entities.FarmState", b =>
                {
                    ...
                    b.Property<DateTime>("LastSaved")
                        ...
                        .HasDefaultValue(new DateTime(2025, 7, 2, 22, 6, 11, 720, DateTimeKind.Utc).AddTicks(430));
            ...
            modelBuilder.Entity("KunFarm.DAL.Entities.PlayerState", b =>
                {
                    ...
                    b.Property<DateTime>("LastSaved")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 7, 3, 5, 6, 11, 718, DateTimeKind.Local).AddTicks(4810));
            ...
            modelBuilder.Entity("KunFarm.DAL.Entities.PlayerToolbar", b =>
                {
                    ...
                    b.Property<DateTime>("LastSaved")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 7, 3, 5, 6, 11, 719, DateTimeKind.Local).AddTicks(340));
